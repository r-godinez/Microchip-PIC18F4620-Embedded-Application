...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Lab13.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ST7735_TFT.c Fan_Support.c I2C_Soft.c I2C_Support.c Interrupt.c Main_Screen.c utils.c Interrupt2.c Setup_Time.c Setup_Fan_Temp.c Setup_Alarm_Time.c Main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ST7735_TFT.p1 ${OBJECTDIR}/Fan_Support.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/utils.p1 ${OBJECTDIR}/Interrupt2.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/Setup_Fan_Temp.p1 ${OBJECTDIR}/Setup_Alarm_Time.p1 ${OBJECTDIR}/Main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ST7735_TFT.p1.d ${OBJECTDIR}/Fan_Support.p1.d ${OBJECTDIR}/I2C_Soft.p1.d ${OBJECTDIR}/I2C_Support.p1.d ${OBJECTDIR}/Interrupt.p1.d ${OBJECTDIR}/Main_Screen.p1.d ${OBJECTDIR}/utils.p1.d ${OBJECTDIR}/Interrupt2.p1.d ${OBJECTDIR}/Setup_Time.p1.d ${OBJECTDIR}/Setup_Fan_Temp.p1.d ${OBJECTDIR}/Setup_Alarm_Time.p1.d ${OBJECTDIR}/Main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ST7735_TFT.p1 ${OBJECTDIR}/Fan_Support.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/utils.p1 ${OBJECTDIR}/Interrupt2.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/Setup_Fan_Temp.p1 ${OBJECTDIR}/Setup_Alarm_Time.p1 ${OBJECTDIR}/Main.p1

# Source Files
SOURCEFILES=ST7735_TFT.c Fan_Support.c I2C_Soft.c I2C_Support.c Interrupt.c Main_Screen.c utils.c Interrupt2.c Setup_Time.c Setup_Fan_Temp.c Setup_Alarm_Time.c Main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Lab13.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/Interrupt2.p1: Interrupt2.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Interrupt2.p1.d 
	@${RM} ${OBJECTDIR}/Interrupt2.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/Interrupt2.p1 Interrupt2.c 
	@-${MV} ${OBJECTDIR}/Interrupt2.d ${OBJECTDIR}/Interrupt2.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Interrupt2.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/Setup_Fan_Temp.p1: Setup_Fan_Temp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Setup_Fan_Temp.p1.d 
	@${RM} ${OBJECTDIR}/Setup_Fan_Temp.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/Setup_Fan_Temp.p1 Setup_Fan_Temp.c 
	@-${MV} ${OBJECTDIR}/Setup_Fan_Temp.d ${OBJECTDIR}/Setup_Fan_Temp.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Setup_Fan_Temp.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Lab13.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Lab13.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-fd30-ffff --ram=default,-ef4-eff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Lab13.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_default=$(CND_CONF) 
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Lab13.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Lab13.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Lab13.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Lab13.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_default=$(CND_CONF) 
